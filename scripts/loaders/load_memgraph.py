...
def load_data(driver, nodes_path: str, edges_path: str):
    print(f"Loading data into Memgraph from {nodes_path} and {edges_path}")
    ...
    print(f"Memgraph Load complete in {total_time:.2f}s")
...
if __name__ == "__main__":
    ...
    if driver:
        ...
        print("Memgraph driver not configured.")
